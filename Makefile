...
BOOST_ROOT = $(CPP_LIBRARY_ROOT)/boost/1.84.0_1
OPENSSL_ROOT = $(CPP_LIBRARY_ROOT)/openssl@3/3.1.1_1
...
clean:
	rm -f $(DEBUG_BINARY_NAME) $(RELEASE_BINARY_NAME) $(DEBUG_OBJ_FILES) $(RELEASE_OBJ_FILES)
