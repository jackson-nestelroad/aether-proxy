...
X(0xc09A, ECDHE_PSK_CAMELLIA128_SHA25, "TLS_ECDHE_PSK_WITH_CAMELLIA_128_CBC_SHA256") \
X(0xc09B, ECDHE_PSK_CAMELLIA256_SHA38, "TLS_ECDHE_PSK_WITH_CAMELLIA_256_CBC_SHA384") \
...
#undef X
    ...
    namespace convert {
        constexpr std::string_view to_string(cipher_suite_name cipher) {
            switch (cipher) {
#define X(id, name, str) case cipher_suite_name::name: return str;
                CIPHER_SUITE_NAMES(X)
#undef X
            }
