...
namespace proxy::tcp::websocket::protocol {
    ...
    */
    ...
    private:
        ...
        parsing_state state;
        frame current_frame;
        std::optional<opcode> effective_opcode_in;
        std::optional<opcode> effective_opcode_out;

        std::vector<std::unique_ptr<extensions::extension>> extensions;

        util::buffer::buffer_segment header_segment;
        util::buffer::buffer_segment payload_length_segment;
        util::buffer::buffer_segment mask_key_segment;
        util::buffer::buffer_segment payload_segment;
