...
namespace proxy::tcp::websocket::handshake {
    extension_data::extension_data(std::string_view name)
        : name(name)
    { }
    ...
    void extension_data::set_name(std::string_view name) {
        this->name = name;
    }

    bool extension_data::has_param(std::string_view name) const {
